      ...
      >
        ...
        <HeaderSection>
          ...
          <Image
            ...
            style={{ width: 19, height: 19, tintColor: "#3A4276" }}
          />
        </HeaderSection>
        {/* Account Overview */}
        <ScrollView>
          ...
          >
            <View style={{ marginLeft: 25 }}>
              ...
              <Text style={{ fontSize: 16, color: "#7B7F9E" }}>
                Current Balance
              </Text>
            </View>
            <TouchableOpacity
          ...
          {/* Send Money */}
          <HeaderSection style={{ marginTop: 40, flexDirection: "column" }}>
            <Text
              style={{
                // supposed to be 16
                fontSize: 25,
                ...
                return (
                  <View
                    style={{
                      ...
                      marginRight:
                        index === dummyData.SendMoneyRecords.length - 1
                          ? 0
                          : 10,
                    }}
                  >
